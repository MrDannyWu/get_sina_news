...
BOT_NAME = 'get_sina_news'

SPIDER_MODULES = ['get_sina_news.spiders']
NEWSPIDER_MODULE = 'get_sina_news.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'get_sina_news (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'get_sina_news.middlewares.GetSinaNewsSpiderMiddleware': 543,
#}

# Enable or disable downloader middlewares
# See https://doc.scrapy.org/en/latest/topics/downloader-middleware.html
#DOWNLOADER_MIDDLEWARES = {
#    'get_sina_news.middlewares.GetSinaNewsDownloaderMiddleware': 543,
#}
...
ITEM_PIPELINES = {
   'get_sina_news.pipelines.SinaNewsPipeline': 300,
}
